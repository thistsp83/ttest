...
<body>
			...
			<ul class="w3-navbar w3-black w3-card-2 w3-medium  "
				...
				<li><a href="${pageContext.request.contextPath}/Welcomepage"
					class="w3-hover-none w3-text-sand w3-hover-text-white"><i
						class="fa fa-home"></i> V I D E O K A R T </a></li>
				<c:choose>
				...
				<div>
					<div id="carousel-home" class="carousel slide">
						...
						<div class="carousel-inner" role="listbox">
							...
							<div class="item">
								<img
									src="<c:url value="/resources/images/corousel/image5.jpg"></c:url>"
									alt="Dell">
								<div class="carousel-caption">
									<span></span>
								</div>
	...
	<footer class="footer-distributed w3-card-4 w3-black w3-margin-0"
		...
		<div class="footer-left" style="margin-top: 10px">
			...
			<p></p>
			<p>
				V I D E O K A R T <i class="fa fa-copyright" aria-hidden="true"> 2017</i>
			</p>
			<p></p>
		...
		<div class="footer-center">
			...
			<div>
				...
				<p>
					<a href="mailto:support@company.com">support@videokart.com</a>
				</p>
			</div>
		</div>
		<div class="footer-right">
			<p class="footer-company-about">
				<span>About the company</span> <a href="http://www.secura.e-sim.org"
					title="Summus, website template creation">Video Kart</a> is a online - web
				based video kart company. We provice the all type of videos for to build.
			</p>
		</div>
	</footer>
